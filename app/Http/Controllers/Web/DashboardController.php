...
class DashboardController extends Controller
{
    ...
    public function index($id = null, Request $request) {
        ...
        if (auth()->user()->isCustomer()) {
            ...
            return$request->ajax()?view("pages.paginationds", compact('orders', 'month', 'hirarki', 'royalty', 'all_role', 'text_dashboard', 'user', 'checkMitraRequirement', 'role', 'monthly_transaction', 'minimal_transaction')):
