                                ...
                                @endphp
                                    @foreach (Cart::content() as $item )
                                        <tr>
                                            ...
                                            <td class="">
                                               <input wire:model="itemQty.{{$item->rowId}}.options.note" value="{{json_decode(json_encode($item->options), true)['note']}}" wire:change="addNote('{{$item->rowId}}', $event.target.value)" name="cart-note" type="text" >
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
