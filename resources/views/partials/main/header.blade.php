                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-4">
                        <div class="logo text-center">
                            <a href="/"><img src="{{ asset('assets/img/logo/logo.png') }}" alt="NatureCircle"></a>
                        </div>
                    </div>
                    <div class="col-lg-5 col-sm-8">
                        <div class="header-content d-flex justify-content-end">
                                ...
                                <div class="settings-content">
                                    ...
                                    <ul>
                                        @if(Auth::guard('web')->check())
                                            ...
                                            <li><a href="/dashboard/pengaturan/profile">My Profile</a></li>
                                            <li>
                            ...
                            @if (Request::route()->getName() == 'member.shop')
                                        ...
                                        @if (Cart::count() >0)
                                            @foreach (Cart::content() as $item )
                                                <div class="single-cart-item">
                                                    <div class="cart-img">
                                                        <a href="/cart"><img src="{{ asset('assets/img/cart/1.jpg') }}" alt=""></a>
                                                    </div>
