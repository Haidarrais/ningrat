                        ...
                        <div class="featured-carousel-wrapper">
                            ...
                            <div class="feaured-carousel">
                                <div class="single-featured-carousel">
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/4.jpg') }}" alt=""></a>
                                        </div>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/17.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/7.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/15.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                ...
                                <div class="single-featured-carousel">
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/1.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/2.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/3.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/5.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                ...
                                <div class="single-featured-carousel">
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/6.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/8.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/9.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                        ...
                        <div class="featured-carousel-wrapper">
                            ...
                            <div class="feaured-carousel">
                                <div class="single-featured-carousel">
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/10.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/12.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/13.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/14.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                ...
                                <div class="single-featured-carousel">
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/16.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/18.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
                                    ...
                                    <div class="single-featured-item">
                                        <div class="feature-image">
                                            <a href="shop.html"><img src="{{ asset('assets/img/featured/19.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="product-text">
                                            <div class="product-rating">
                                                <i class="fa fa-star-o color"></i>
